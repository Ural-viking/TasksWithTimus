...
Каждый вечер он ставит велосипед на сигнализацию и пристёгивает к специальной стойке одним из замков.
...
public class Task_1877 {
    public static void main(String[] args){
        ...
        String code1 = scr.nextLine();
        String code2 = scr.nextLine();

        int one = Integer.valueOf(code1);
        int two = Integer.valueOf(code2);
